...
$(document).ready(function () {
    ...
    $.ajax({
        type: "GET",
        url: "https://api.github.com/repos/TScott55/AspireRP-Launcher/releases/latest",
        dataType: "json",
        success: function(result) {
        
            if (result.tag_name != current_version) {
                $("#update-alert").show();
                $("#update-url").html("https://github.com/TScott55/AspireRP-Launcher/releases" + result.tag_name + ".zip");
                $("#update-url").attr("href", "https://github.com/TScott55/AspireRP-Launcher/releases" + result.tag_name + ".zip"); 
            }
        }
    });
});